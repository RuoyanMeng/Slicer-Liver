...
#ifndef SLICERLIVER_vtkOpenGLResection2DPolyDataMapperTestTEST_H
#define SLICERLIVER_vtkOpenGLResection2DPolyDataMapperTestTEST_H
...
//-------------------------------------------------------------------------------
class VTKRENDERINGOPENGL2_EXPORT vtkOpenGLResection2DPolyDataMapperTest : public vtkOpenGLPolyDataMapper
{
public:
    static vtkOpenGLResection2DPolyDataMapperTest *New();
vtkTypeMacro(vtkOpenGLResection2DPolyDataMapperTest, vtkOpenGLPolyDataMapper);
...
protected:
    vtkOpenGLResection2DPolyDataMapperTest();
    ~vtkOpenGLResection2DPolyDataMapperTest();
...
private:
    vtkOpenGLResection2DPolyDataMapperTest(const vtkOpenGLResection2DPolyDataMapperTest&) = delete;
    void operator=(const vtkOpenGLResection2DPolyDataMapperTest&) = delete;
};


#endif //SLICERLIVER_vtkOpenGLResection2DPolyDataMapperTestTEST_H
